...
mod tests {
  ...
  //"Key (resource_id, timespan)=(ocean room view 713, [\"2022-12-26 22:00:00+00\",\"2022-12-30 19:00:00+00\")) conflicts with existing key (resource_id, timespan)=(ocean room view 713, [\"2022-12-25 22:00:00+00\",\"2022-12-28 19:00:00+00\"))."
  #[test]
  ...
  fn conflict_error_message_should_parse() {
    // let s = "Key (resource_id, timespan)=(ocean-view-room-713, [\"2022-12-26 22:00:00+00\",\"2022-12-30 19:00:00+00\")) conflicts with existing key (resource_id, timespan)=(ocean-view-room-713, [\"2022-12-25 22:00:00+00\",\"2022-12-28 19:00:00+00\")).";
