...
impl Rsvp for ReservationManager {
  ...
  async fn update_note(&self, _id: ReservationId) -> Result<abi::Reservation, abi::Error> {
    todo!("");
  }
...
mod test {
  ...
  async fn reserve_should_work_for_valid_window() {
    ...
    let rsvp = abi::Reservation::new_pending(
      ...
      "I'll arrive at 3pm, Please help to upgrade to executive root if possible."
    );
